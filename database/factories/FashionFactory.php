...
class FashionFactory extends Factory
{
    ...
    {
        return [
            'title'=> fake()->randomElement(['CollectionGreenNest Plant','JuiceElegance Fashion','BottleSilkTouch Bed','Tree Pot','LinensVitaBoost Smoothie','MixChicStyle Handbag','FertilizerUrbanPulse','SetAquaPure Water','EcoLeaf Tree PotSunburst Citrus']),
