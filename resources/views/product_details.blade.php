...
<html lang="en">
    <head>
        ...
        <link href="{{asset('assets//tooplate-little-fashion.css')}}" rel="stylesheet">
<!--
        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="{{route('fashion.index')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-thumb">
                                <img src="{{asset('images//product/evan-mcdougall-qnh1odlqOmk-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="{{route('products.show')}}">
                                    <img src="{{asset('images//product/jordan-nix-CkCUvwMXAac-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="{{asset('images//product/nature-zen-3Dn1BZZv3m8-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>
